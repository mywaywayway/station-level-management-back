...
public class Generator {
    ...
    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"context_owner","toll_invoice","equipment","inboundrecords","logs","materials","outboundrecords","quota_ticket","spareparts","ticket","user","warehouses"};
